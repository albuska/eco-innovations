...
const LegalSupportForEnergySector = () => {
  return (
    ...
    >
      <div
        className={`${style.container_inside} flex flex-col items-center gap-[32px] p-11 rounded-[12px] max-w-[636px] lg:max-w-[687px] xl:max-w-[836px] mx-auto`}
      >
        <h2 className="font-extrabold text-[var(--white-color)] text-center text-[28px] sm:text-[32px] leading-[34.13px] sm:leading-[39.01px] tracking-[-0.02em] xl:text-[42px] xl:leading-[51.2px]">
          Юридичний супровід енергетики: надання статусу <br /> &quot;Активний
          споживач&quot;
        </h2>
